...
To allow another user to create and edit rooms, assign them a role which has the permissions edit_bbb_rooms, publish_bbb_rooms, delete_bbb_rooms, delete_published_bbb_rooms, and edit_published_bbb_rooms. The permission structure is similar for posts and pages.

To allow another user to create and edit room categories, assign them a role which has the permissions manage_categories. This does not give them permission to create rooms. They can only manage room categories.
