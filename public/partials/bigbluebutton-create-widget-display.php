<div class="bbb-top-bottom-margin">
    ...
    <p>
        <label for="<?php echo $button_text_id; ?>" class="bbb-width-30 bbb-inline-block"><?php esc_html_e( 'Button Text', 'bigbluebutton' ); ?>:</label>
        <input class="widefat" id=<?php echo esc_attr( $button_text_id ); ?> name="<?php echo esc_attr( $button_text_name ); ?>" type="text" value="<?php echo esc_attr( $button_text_value ); ?>" />
    </p>
    <p>
